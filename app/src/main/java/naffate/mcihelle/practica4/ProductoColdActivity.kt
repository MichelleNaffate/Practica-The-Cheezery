...
class ProductoColdActivity : AppCompatActivity() {
    var coldDrinks =  ArrayList<Product>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_productos_cold)
        agregarProductos()

        var listView: ListView = findViewById(R.id.view)as ListView
        var adaptador: AdaptorProductos = AdaptorProductos(this,coldDrinks)
